...
$peerConnectionOptions = "{ \""iceServers\"": [{\""urls\"": [\""stun:stun1.l.google.com:19302\"",\""turn:192.168.51.18:19303\""], \""username\"": \""PixelStreamingUser\"", \""credential\"": \""AnotherTURNintheroad\""}] }"
